...
18.04.2026
**cleanup of useless libraries (currently not like they are literally useless)
## Standardy a normy
Projekt vychází z mezinárodních standardů pro identifikační karty:
- [ISO/IEC 7810](https://en.wikipedia.org/wiki/ISO/IEC_7810) – Fyzické charakteristiky (rozměry CR80, CR79 atd.)
- [ISO/IEC 7811](https://en.wikipedia.org/wiki/ISO/IEC_7811) – Techniky záznamu (magnetické proužky, embossing)
